...
semantic HTML means HTML tags that has meaning
...
Version control makes the development phase more accessible and controllable for each team member for example branches and abilty to go back your old-codes when something unexpected happened.
